...
public class C01_MethodCreation {
	...
	public static void main(String[] args) {
		// kullanicidan ismini ve soyisini isteyin
		// iki farkli method olusturun methodlardan biri girilen kelimeleri 
		// ilk harf buyuk, digerleri kucuk olacak sekilde birleþtirsin(concat)
		// Ikýnci method Isim ve soyismin ilk harfleri buyuk harf, 
